...
class DismantlingConsignmentNote extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Models\DismantlingConsignmentNote::class;
    ...
    {
        return __('Demont. važtaraščiai');
    }

    public static function singularLabel()
    {
        return __('Demont. važtaraštis');
    }
